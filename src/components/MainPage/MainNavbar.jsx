  ...
  return (
    <>
      <div className="fixed w-full z-10">
            ...
            <>
              ...
              {userType === "doctor" ? (
                <button
                  className="bg-brightColor text-white px-4 py-2 rounded-md hover:bg-yellow-300 transition duration-300 ease-in-out mt-2 block"
                  onClick={() =>
                    (window.location.href = `/doctor_profile/${user_id}`)
                  }
                >
                  Profile
                </button>
                ...
                <button
                  className="bg-brightColor text-white px-4 py-2 rounded-md hover:bg-yellow-300 transition duration-300 ease-in-out mt-2 block"
                  onClick={() =>
                    (window.location.href = `/patient_profile/${user_id}`)
                  }
                >
                  Profile
                </button>
        ...
        {showLoginForm && (
          <Login closeForm={closeLoginForm} setIsLoggedIn={setIsLoggedIn} />
        )}
      ...
      <Routes>
        ...
        <Route
          path="/meal_insights"
          element={<GlycemicLoadRecommendations />}
        />
        <Route path="/appointment" element={<Appointment />} />
        <Route
          path="/ws/appointments/:doctorId/:patientId/messages"
          element={<Messages />}
        />
